    ...
    return (
        <div className="flex flex-col md:grid md:grid-cols-2 h-100 w-full bg-white">
            <div className="flex-1 relative w-full h-1/2 md:h-full">
                <img src="/banners/Background.webp" className="absolute inset-0 w-full h-full object-cover brightness-80 pointer-events-none select-none" width="665" height="398" loading="eager" fetchPriority="high" alt="" decoding="async" aria-hidden="true" />
            </div>
