                    ...
                    {!autoPlay && (
                        <div>
                            <button onClick={play} className="pt-1.5 pl-1.5 absolute">
                                <img title="Continuar animação" className="bg-white/70 h-4 rounded-full cursor-pointer duration-250 hover:rotate-200" src="https://img.icons8.com/metro/90/synchronize.png" alt="icone-retormar" />
                            </button>

                            <img className="absolute mt-8 ml-1.5 bg-white/70 h-4 rounded-full duration-250" src="https://img.icons8.com/external-creatype-outline-colourcreatype/90/external-zoom-photo-camera-interface-creatype-outline-colourcreatype-2.png" alt="Zoom" />
                        </div>
                    )}
