...
import { logo, btc, pix, dominio, zap, twitter, face, link, github } from "../../../../config/imagem";

export default function Introducao({ projeto, categoria, dark }) {
    const notificacaoLink = useNotificacao(2500)
    const notificacaoBitcoin = useNotificacao(3000)
